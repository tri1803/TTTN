...
namespace Temp.DataAccess.Migrations
{
    ...
    [Migration("20200223091758_updateProductType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Temp.DataAccess.Data.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Temp.DataAccess.Data.Cart", b =>
                {
                    ...
                    b.HasOne("Temp.DataAccess.Data.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Temp.DataAccess.Data.Product", b =>
                {
                    ...
                    b.HasOne("Temp.DataAccess.Data.ProductType", "ProductType")
                        .WithMany("Products")
